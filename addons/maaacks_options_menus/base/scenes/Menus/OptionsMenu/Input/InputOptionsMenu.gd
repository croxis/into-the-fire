...
@export var action_name_map : Dictionary = {
	"throttle_backwards": "Backwards Axis",
	"throttle_forward": "Forward Axis",
	"right_rotation": "Yaw Right Rotation Axis",
	"left_rotation": "Yaw Left Rotation Axis",
	"up_rotation": "Pitch Up Axis",
	"down_rotaion": "Pich Down Axis",
	"clock_rotation": "Roll Right Axis",
	"counter_rotation": "Roll Left Axis",
	"forward_full_thrust": "Full Throttle Button",
	"backwards_full_thrust": "Backwards Full Thrust",
	"slide_left_full": "Strafe Left Button",
	"slide_right_full": "Strafe Right Button",
	"slide_up_full": "Strafe Up Button",
	"slide_down_full": "Strafe Down Button",
}
...
func _on_set_keybindings_pressed():
	visible != visible
